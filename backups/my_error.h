...
typedef struct System_Error_log  //系统错误记录结构体
{
    time_t time;                //错误发生的时间
...
typedef struct System_Register_Log //系统登录注册记录结构体
{
